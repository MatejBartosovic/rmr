...
public:
    ...
    int ConnectToPort(std::string comportT,QWidget * parent=0 );
    ...
    int moveMotors(DWORD right,DWORD left){SentToCreate(OI_DRIVE_DIRECT,right,left);}
    int moveRobot(DWORD linear,DWORD radius){SentToCreate(OI_DRIVE,linear,radius);}
