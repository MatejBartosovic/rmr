...
static const char qt_meta_stringdata_LocalMap[] = {
    "LocalMap\0\0newMap()\0"
};

void LocalMap::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        LocalMap *_t = static_cast<LocalMap *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData LocalMap::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LocalMap::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_LocalMap,
      qt_meta_data_LocalMap, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LocalMap::getStaticMetaObject() { return staticMetaObject; }
